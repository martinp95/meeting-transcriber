...
git clone https://github.com/mpelaez/meeting-transcribe.git
...
docker run -p 3000:3000 \
  ...
  ghcr.io/mpelaez/meeting-transcribe:latest
```
...
```bash
docker run -p 3000:3000 -e GEMINI_API_KEY=tu_key ghcr.io/mpelaez/meeting-transcribe:latest
```
...
docker run -d -p 80:3000 -e GEMINI_API_KEY=tu_key ghcr.io/mpelaez/meeting-transcribe:latest
```
